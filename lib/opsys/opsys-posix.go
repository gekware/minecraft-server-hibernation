...
func procTreeSuspend(ppid uint32) *errco.MshLog {
	...
	*/
	...
	errco.Logln(errco.TYPE_INF, errco.LVL_3, errco.ERROR_NIL, "suspending pid [%d]", ppid)
...
func procTreeResume(ppid uint32) *errco.MshLog {
	...
	*/
	...
	errco.Logln(errco.TYPE_INF, errco.LVL_3, errco.ERROR_NIL, "resuming pid [%d]", ppid)
